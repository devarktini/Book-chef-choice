...
"[project]/app/occasion/page.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function Occasion() {
    ...
    const [OccasionState, setOccasionState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([
        {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Occasion.useEffect": ()=>{
            const serviceData = userInputData.find({
                "Occasion.useEffect.serviceData": (item)=>item.id === "service-select"
            }["Occasion.useEffect.serviceData"]);
            if (serviceData) setServiceType(serviceData.data);
            const occasionData = userInputData.find({
                "Occasion.useEffect.occasionData": (item)=>item.id === "occasion"
            }["Occasion.useEffect.occasionData"]);
            if (occasionData) {
                setOccasionState({
                    "Occasion.useEffect": (prev)=>prev.map({
                            "Occasion.useEffect": (service)=>({
                                    ...service,
                                    options: service.options.map({
                                        "Occasion.useEffect": (opt)=>({
                                                ...opt,
                                                isActiv: opt.text === occasionData.data || opt.text === occasionData.text
                                            })
                                    }["Occasion.useEffect"])
                                })
                        }["Occasion.useEffect"])
    ...
    function handleOccasionClick(id, occasionIndex) {
        setOccasionState((prev)=>prev.map((service, sIndex)=>{
                if (sIndex !== occasionIndex) return service;
                return {
                    ...service,
                    options: service.options.map((opt)=>opt.id === id ? {
                            ...opt,
                            isActiv: true
                        } : {
                            ...opt,
    ...
    function handleOccasionBtnClick() {
        ...
        const userSelectedData = OccasionState[selectedServiceIndex].options.find((opt)=>opt.isActiv);
        if (userSelectedData) {
            addUserInputData({
                id: "occasion",
                data: userSelectedData.text
            });
            return true;
        } else {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"])("Select an occasion!");
            return false;
        }
    }
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Components$2f$Container$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: ocassionSelectData.title
                    }, void 0, false, {
                        fileName: "[project]/app/occasion/page.jsx",
                        lineNumber: 99,
                        columnNumber: 9
                    }, this),
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: "text-center text-white",
                        children: ocassionSelectData.text
                    }, void 0, false, {
                        fileName: "[project]/app/occasion/page.jsx",
                        lineNumber: 102,
                        columnNumber: 9
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: OccasionState.map((service, index)=>ServiceType === service.service_type ? service.options.map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            onClick: ()=>handleOccasionClick(item.id, index),
                            className: "flex justify-between border rounded-md p-2 cursor-pointer ".concat(item.isActiv ? "bg-orange-500 text-white border-white" : "border-white text-white"),
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
_s(Occasion, "pKcxA9z6byd1zw93qv4s24vbXxs=", false, function() {
    return [
...
_c = Occasion;
const __TURBOPACK__default__export__ = Occasion;
var _c;
__turbopack_context__.k.register(_c, "Occasion");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_42f3b22a._.js.map