...
"[project]/app/schedule/service/page.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ServicesSchedule() {
    ...
    const serviceScheduledata = {
        ...
        hintText: "Uncheck the meals you don't need. Swipe down the calendar to see all the dates. 😉"
    };
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ServicesSchedule.useEffect": ()=>{
            var _userInputData_find, _userInputData_find1, _userInputData_find2;
            const startDate = (_userInputData_find = userInputData.find({
                "ServicesSchedule.useEffect": (item)=>item.id === "date-select"
            }["ServicesSchedule.useEffect"])) === null || _userInputData_find === void 0 ? void 0 : _userInputData_find.data.startDate;
            const endDate = (_userInputData_find1 = userInputData.find({
                "ServicesSchedule.useEffect": (item)=>item.id === "date-select"
            }["ServicesSchedule.useEffect"])) === null || _userInputData_find1 === void 0 ? void 0 : _userInputData_find1.data.endDate;
            ...
            const savedSchedule = (_userInputData_find2 = userInputData.find({
                "ServicesSchedule.useEffect": (item)=>item.id === "services-schedule"
            }["ServicesSchedule.useEffect"])) === null || _userInputData_find2 === void 0 ? void 0 : _userInputData_find2.data;
            if (savedSchedule && savedSchedule.length === datesArray.length) {
                setSchedule(savedSchedule);
            } else {
                const newSchedule = datesArray.map({
                    "ServicesSchedule.useEffect.newSchedule": (date)=>({
                            date,
                            breakfast: true,
                            lunch: true,
                            dinner: true,
                ...
                }["ServicesSchedule.useEffect.newSchedule"]);
    ...
    const handleCheckboxChange = (index, meal)=>{
        setSchedule((prev)=>prev.map((item, idx)=>idx === index ? {
                    ...item,
                    [meal]: !item[meal]
                } : item));
    };
    ...
    const onNextBtnClick = ()=>{
        if (!schedule || schedule.length === 0) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"])("No schedule selected!");
            return false;
        }
        addUserInputData({
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    ...
                    children: serviceScheduledata.title
                }, void 0, false, {
                    fileName: "[project]/app/schedule/service/page.jsx",
                    lineNumber: 93,
                    columnNumber: 9
                }, this)
            }, void 0, false, {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                    className: "w-full border border-gray-300 text-center text-white",
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                            children: schedule.map((item, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                            ...
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                                ...
                                                onChange: ()=>handleCheckboxChange(index, "eveningSnacks"),
                                                className: "w-6 h-6 accent-orange-500 cursor-pointer"
                                            }, void 0, false, {
                                                fileName: "[project]/app/schedule/service/page.jsx",
                                                lineNumber: 139,
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                            ...
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                                ...
                                                className: "border rounded p-1 w-full text-white bg-transparent placeholder-white"
                                            }, void 0, false, {
                                                fileName: "[project]/app/schedule/service/page.jsx",
                                                lineNumber: 149,
                                                columnNumber: 19
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "p-3 my-2 bg-orange-300 text-white w-4/5 font-semibold text-center mx-auto",
                children: serviceScheduledata.hintText
            }, void 0, false, {
                fileName: "[project]/app/schedule/service/page.jsx",
                lineNumber: 163,
                columnNumber: 7
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "flex justify-center mt-7 space-x-5",
                children: [
...
_s(ServicesSchedule, "CpGWSDQXPHd0jwdGpHDI6DrjgMc=", false, function() {
    return [
...
_c = ServicesSchedule;
const __TURBOPACK__default__export__ = ServicesSchedule;
var _c;
__turbopack_context__.k.register(_c, "ServicesSchedule");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_1cec073b._.js.map