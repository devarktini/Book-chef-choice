...
function Location() {
  ...
  useEffect(() => {
    if (userLocation.addr) {
      addUserInputData({ id: "location", data: userLocation.addr });
    }
  }, [userLocation.addr]);
  ...
  return (
    <Container>
      <div className="text-center my-5" style={{ color: 'var(--text-primary)' }}>
      ...
      <div className="flex justify-center my-10">
        <input
          ...
          style={{ color: 'var(--text-primary)', backgroundColor: 'var(--background)' }}
          type="text"
      ...
      <p className="my-3 text-xl text-center" style={{ color: 'var(--text-primary)' }}>or</p>
      <Link href="/place">
        <p className="md:w-2/5 text-center mx-auto hover:underline" style={{ color: 'var(--text-primary)' }}>
