...
function ServicesPeople() {
  ...
  return (
    <Container>
      <div>
        <p className="text-2xl my-5 font-bold text-center" style={{ color: 'var(--text-primary)' }}>
      ...
      <div className="space-y-5">
        {servicePeople.map((people, index) => (
          ...
          >
            <p className="text-lg" style={{ color: 'var(--text-primary)' }}>{people.category}</p>
            <p style={{ color: 'var(--text-primary)' }}>{people.text}</p>
            <div className="flex mt-4 justify-between items-center">
              ...
              <span className="text-xl" style={{ color: 'var(--text-primary)' }}>{people.count}</span>
              <span
